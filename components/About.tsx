  ...
  return (
    <section id="about" className="scroll-mt-24 py-20 sm:py-28">
      <Container>
        ...
        <StaggerContainer staggerDelay={0.08} className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {focusAreas.map((area) => {
            const Icon = area.icon;
            return (
              <FadeIn key={area.title} direction="up" distance={20} className="h-full">
                <div
